...
class PreprocessImage(object):
    ...
    def threshold(self,image, w=SIZE):
        ...
        # filename = os.path.join(path,'threshold-res.jpg')
    ...
    def super_resolution(self,img,img_path,base):
        ...
        edsr_res = os.path.join(path,img_name)
    ...
    def save (self,base,img,name):
        path = os.path.join(PATH.BASE_PATH.value,PATH.TEMP_PATH.value)
        img_name = base + "_"+name+"_{}.png".format(self.count)
    ...
    def preprocess_image(self,img_path,base=''):
        ...
        return self.files,fsrcnn_res,edsr_res,esrgan_res

    def get_matcher(self,image):
        url = PATH.SERVER_MATCH_URL.value
        print(url)
